import { CalendarPlus, FileText, MapPin, MessageSquare, Package, Search, TicketPercent } from 'lucide-react'
      ...
      <div className="grid two" style={{ marginTop: 16 }}>
        ...
        <div className="card">
          ...
          <div className="kpi-row" style={{ marginTop: 16 }}>
            ...
            <Link className="btn secondary" to="/cliente/recibos">
              <FileText size={16} style={{ verticalAlign: 'middle' }} /> Recibos
            </Link>
